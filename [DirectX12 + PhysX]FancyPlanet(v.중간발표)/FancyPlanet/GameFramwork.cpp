...
void CGameFramework::FrameAdvance()
{
	...
	//m_pPxPhysicsSDK->getPvdConnectionManager()->setCamera("PhysXCamera",
	//	PxVec3(m_pCamera->GetPosition().x, m_pCamera->GetPosition().y, m_pCamera->GetPosition().z),
	//	PxVec3(m_pCamera->GetUpVector().x, m_pCamera->GetUpVector().y, m_pCamera->GetUpVector().z),
	//	PxVec3(m_pCamera->GetLookVector().x, m_pCamera->GetLookVector().y, m_pCamera->GetLookVector().z));
	...
	//PxVec3(m_pCamera->GetYaw(), m_pCamera->GetPitch(), m_pCamera->GetRoll()));
